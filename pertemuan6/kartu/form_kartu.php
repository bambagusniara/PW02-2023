...
<form method="POST" action="proses_kartu.php" class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" name="diskon" 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="iuran" value="<?php if(isset($row['iuran'])) echo $row['iuran']; ?>"
